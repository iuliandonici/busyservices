...
function f_install_cosmic() {
  ...
  doas apk add elogind dbus polkit-elogind cosmic-session cosmic-term cosmic-edit cosmic-greeter cosmic-greeter-openrc cosmic-icons cosmic-idle cosmic-initial-setup
