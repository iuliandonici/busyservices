#!/bin/bash
var_install_base_software_array=("lsb-release" "hostname" "wget" "curl" "keychain" "net-tools" "unzip" "awk" "git" "nano" "ca-certificates" "curl" "gnupg" "software-properties-common" "acl")
