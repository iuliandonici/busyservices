#!/bin/bash
function f_config_kvm_images_alpine_x86_64() {
    echo " - Getting latest standard ISO for Alpine Linux:"
    ...
    # List the downloaded files in reverse order, remove all, except the 1st one and delete the rest
